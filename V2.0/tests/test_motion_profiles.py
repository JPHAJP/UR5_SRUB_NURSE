...
def test_limit_velocity_acceleration_caps_axis_delta():
    result = limit_velocity_acceleration([0.0, 10.0, -10.0], [100.0, -100.0, 5.0], 300.0, 0.1)

    assert result == [30.0, -20.0, 5.0]
